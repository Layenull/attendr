        ...
        <div className="bg-gradblue bg-cover bg-center bg-no-repeat h-screen ">
            ...
            <div className=' flex flex-col justify-center py-16 '>
                ...
                <div className='flex justify-center'>
                    <SelectionCard text="FIRST SEMESTER" bgImage="bg-scientist" link="/CourseRegistration" />
                </div>


                <div className='flex justify-center py-8 '>
                    <SelectionCard text="SECOND SEMESTER" bgImage="bg-creative" link="/CourseRegistration" />
                </div>
